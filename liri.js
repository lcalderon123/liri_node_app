...
var spotify = new Spotify({
  id: 'd7716ae0e23e4ab9b4889ef0987dc8d1',
  secret: '08b459bfbf85467ea03e34715a95cc1f',
});
...
function getMyTweets(){
	...
	var params = {screen_name: 'lady_fantastica', count: 20, exclude_replies:true, trim_user:true};
...
function movieThis(movieName){
	...
	request(" http://www.omdbapi.com/?i=tt3896198&apikey=ac50acd9" + movieName, function(error, response, body) {
  	...
  	if (!error && response.statusCode === 200) {
	    ...
	    var queryURL = "http://www.omdbapi.com/" + movieID + "?api_key=" + ac50acd9 + "&append_to_response=credits,releases";
